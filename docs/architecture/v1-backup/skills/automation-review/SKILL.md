...
when:
  - después de ejecutar Cypress correctamente
...
Al finalizar la revisión, generar además un resumen ejecutivo corto (máximo 10 líneas) orientado al Manager Agent.
...
No repetir el análisis completo.
No volver a listar todas las observaciones.
Debe ser un resumen de alto nivel para facilitar la toma de decisiones.
