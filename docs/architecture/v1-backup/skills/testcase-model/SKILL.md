...
Construir un Modelo Canónico de Test Case independiente de Zephyr.

Este skill no conoce la API REST de Zephyr.
...
Este modelo será consumido posteriormente por ProductAgent para crear el Test Case real en Zephyr.
